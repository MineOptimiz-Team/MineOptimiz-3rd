...
if "%updateversion%"=="1" (
  echo 下载Stable更新包中...
  certutil -urlcache -split -f https://nightly.link/SmallMushroom-offical/MineOptimiz-Next/workflows/main/1.19.4-OptiFabric-Stable ".\Update.zip"
)
if "%updateversion%"=="2" (
  echo 下载Dev更新包中...
  certutil -urlcache -split -f "https://nightly.link/SmallMushroom-offical/MineOptimiz-Next/workflows/main/1.19.4-OptiFabric-Dev" ".\Update.zip"
)
if errorlevel 1 (
  echo 下载失败！
  pause
